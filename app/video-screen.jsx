...
export default function VideoCallScreen() {
  ...
  const { interviewId, channelName } = params;
  ...
  const initAgora = async () => {
    try {
      ...
      // Set video configuration for HD
  ...
  const leaveChannel = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Call Ended',
        'You have left the interview call.',
        [
          {
            text: 'OK',
            onPress: () => router.back(),
    ...
    <View style={styles.container}>
        ...
        {remoteUid > 0 ? (
          ...
          <View style={styles.placeholder}>
            <View style={styles.placeholderIconContainer}>
              <Ionicons name="person-outline" size={64} color={theme.colors.neutral.white} />
            </View>
      ...
      <View style={styles.localView}>
        {isJoined && !videoDisabled ? (
          ...
          <View style={styles.localPlaceholder}>
            <Ionicons name="videocam-off" size={32} color={theme.colors.neutral.white} />
          </View>
        )}
      </View>
      ...
      <View style={styles.topBar}>
        ...
        <TouchableOpacity style={styles.switchCameraButton} onPress={switchCamera}>
          <Ionicons name="camera-reverse-outline" size={24} color={theme.colors.neutral.white} />
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.controls}>
        ...
        <TouchableOpacity
          style={[styles.controlButton, videoDisabled && styles.controlButtonActive]}
          onPress={toggleVideo}
        >
          <Ionicons
